...
export class Contact extends Component {
    ...
    constructor(props) {
      ...
      onSubmit(e) {
        ...
        axios.post('http://127.0.0.1:8000/api/contact/', contactObject)
        .then((res) => {
                 ...
                 <div className="container">
                    ...
                    <div className="row box-card">
                        ...
                        <div className="socials">
                            <ul>
                            <li>
                                <a href="https://www.linkedin.com/in/andr%C3%A9-d%C3%A2maso-29b830182/" target="_blank" rel="noopener noreferrer">
                                <AiFillLinkedin size={40} style={{ color: "grey" }}/>
                                </a>
                            </li>
                            <li>
                                <a href="https://github.com/andredamaso96" target="_blank" rel="noopener noreferrer">
